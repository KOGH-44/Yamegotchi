...
int print_myMonster(Animal& chick_obj, const char* base, const char* type_)
{
	...
	if (type_input == 1) {
		...
		while (1)
		{
			...
			case 2:
				...
				print_myMonster(myAnimal, "유년기(조류)", "조류");
				break;
			case 3:
			case 4:
			case 5:
				//print_myMonster(myAnimal, "알에서막부화한병아리");
				print_myMonster(myAnimal, "성장기(조류)", "조류");
				break;
			case 6:
			case 7:
				//print_myMonster(myAnimal, "걸어다니는병아리");
				print_myMonster(myAnimal, "성숙기(조류)", "조류");
				break;
			case 8:
			case 9:
				//print_myMonster(myAnimal, "닭");
				print_myMonster(myAnimal, "완전체(조류)", "조류");
				break;
			default:
				//print_myMonster(myAnimal, "불사조");
				print_myMonster(myAnimal, "궁극체(조류)", "조류");
				break;
				}
			}
			//print_myMonster(myAnimal, "알에서막부화한병아리");
